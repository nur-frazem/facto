            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="mt-1 px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white">
                    {user?.email || '--'}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-1 flex gap-2">
                    <input
                      ...
                      className={`flex-1 px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:border-accent-blue transition-colors ${!canChangeName ? 'opacity-50 cursor-not-allowed' : ''}`}
                ...
                <div>
                  ...
                  <div className="mt-1 px-3 py-2 bg-white/5 border border-white/10 rounded-lg">
                ...
                {/* Account status */}
                <div>
                  <label className="text-slate-400 text-sm">Estado de la cuenta</label>
                  <div className="mt-1 px-3 py-2 bg-white/5 border border-white/10 rounded-lg">
                    <span className={`inline-block px-2 py-0.5 rounded text-sm font-medium ${
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-white/10">
                  <label className="text-slate-400 text-sm">Sesión actual</label>
                  <div className="mt-2 grid grid-cols-2 gap-3">
                    <div className="px-3 py-2 bg-white/5 border border-white/10 rounded-lg">
                      <div className="text-slate-500 text-xs">Iniciada a las</div>
                      <div className="text-white font-mono">{getSessionStart()}</div>
                    </div>
                    <div className="px-3 py-2 bg-white/5 border border-white/10 rounded-lg">
                      <div className="text-slate-500 text-xs">Tiempo restante</div>
                      <div className="text-white font-mono">{getSessionRemaining()}</div>
                    </div>
                  </div>
                  <p className="text-slate-500 text-xs mt-2">
                ...
                {userData?.creadoEn && (
                  <div className="pt-4 border-t border-white/10">
                    <label className="text-slate-400 text-sm">Cuenta creada</label>
                    <div className="mt-1 px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white font-mono text-sm">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {getPermissions().length === 0 && (
                  <span className="text-slate-500 text-sm">Sin permisos asignados</span>
                )}
              </div>
            </div>
              ...
              {loadingStats ? (
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-center">
                    ...
                    <div className="text-slate-400 text-xs mt-1">Documentos creados</div>
                  </div>
                  <div className="px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-center">
                    <div className="text-2xl font-bold text-yellow-400">{activityStats.documentosEditados}</div>
                    <div className="text-slate-400 text-xs mt-1">Documentos editados</div>
                  </div>
                  <div className="px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-center">
                    <div className="text-2xl font-bold text-danger">{activityStats.documentosEliminados}</div>
                    <div className="text-slate-400 text-xs mt-1">Documentos eliminados</div>
                  </div>
                  <div className="px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-center">
                    <div className="text-2xl font-bold text-success">{activityStats.pagosRealizados}</div>
                    <div className="text-slate-400 text-xs mt-1">Pagos procesados</div>
                  </div>
                  <div className="px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-center">
                    <div className="text-2xl font-bold text-orange-400">{activityStats.pagosRevertidos}</div>
                    <div className="text-slate-400 text-xs mt-1">Pagos revertidos</div>
                  </div>
                  <div className="px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-center">
                    <div className="text-2xl font-bold text-purple-400">{activityStats.revinculaciones}</div>
                    <div className="text-slate-400 text-xs mt-1">Revinculaciones</div>
                  </div>
                </div>
              )}
